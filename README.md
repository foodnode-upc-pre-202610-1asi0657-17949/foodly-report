    ...
    <table border="1" style="width:100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px;">
        ...
        <tbody>
            ...
            <tr style="background-color: #fafafa;">
                ...
                <td style="padding: 8px; text-align: center;">28/04/26</td>
                <td style="padding: 8px;">Villanueva Andrade, Ysaac Ligorio</td>
                <td style="padding: 8px;">Desarrolló el AAD iterations, architecture design backlog, drivers selections, refinement, responsability assignment, kanban board y análisis del diseño actual</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">2.1</td>
                <td style="padding: 8px; text-align: center;">29/04/26</td>
                <td style="padding: 8px;">Jasmin Adriana, Urrutia Pena</td>
                <td style="padding: 8px;">Desarrolló principle statements, architecture styles, design patterns y tactics</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">2.2</td>
                <td style="padding: 8px; text-align: center;">30/04/26</td>
                <td style="padding: 8px;">Diego Alonso, Cacho Seminario</td>
                <td style="padding: 8px;">Desarrolló el context diagram, relational and non-relational database diagrams and design purpose</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">2.3</td>
                <td style="padding: 8px; text-align: center;">01/05/26</td>
                <td style="padding: 8px;">Fabricio Samir, Vega Coronado </td>
                <td style="padding: 8px;">Desarrolló el architecture drivers, primary functionality, quality attribute scenarios, constraints  y architecture concerns</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">2.4</td>
                <td style="padding: 8px; text-align: center;">01/05/26</td>
                <td style="padding: 8px;">Sergio Gino Julca Minaya</td>
                <td style="padding: 8px;">Desarrolló el design concepts, viewpoints y ER diagrams, approach driven viewpoints diagrams, sketch views y registro de decisiones</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">3.0</td>
                <td style="padding: 8px; text-align: center;">10/05/26</td>
                <td style="padding: 8px;">Cacho Seminario, Diego Alonso</td>
                <td style="padding: 8px;">Configuración del entorno de desarrollo de software, gestión de código fuente (GitFlow), definición de guías de estilo, convenciones y configuración de despliegue.</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">3.1</td>
                <td style="padding: 8px; text-align: center;">10/05/26</td>
                <td style="padding: 8px;">Julca Minaya, Sergio Gino</td>
                <td style="padding: 8px;">Implementación de Backend Application Core Testing Suite, aplicaciones basadas en patrones y reporte de refactorización orientado a frameworks.</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">3.2</td>
                <td style="padding: 8px; text-align: center;">11/05/26</td>
                <td style="padding: 8px;">Vega Coronado, Fabricio Samir</td>
                <td style="padding: 8px;">Gestión del Sprint Backlog 1, recopilación de evidencias de desarrollo y preparación de la suite de pruebas para el Sprint Review.</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">3.3</td>
                <td style="padding: 8px; text-align: center;">11/05/26</td>
                <td style="padding: 8px;">Urrutia Peña, Jasmin Adriana</td>
                <td style="padding: 8px;">Documentación de evidencias de ejecución y elaboración de la documentación técnica de Microservicios para el cierre del Sprint.</td>
            </tr>
            <tr style="background-color: #fafafa;">
                <td style="padding: 8px; text-align: center;">3.4</td>
                <td style="padding: 8px; text-align: center;">12/05/26</td>
                <td style="padding: 8px;">Villanueva Andrade, Ysaac Ligorio</td>
...
En esta sección se presenta el Lean UX Canvas de Foodly, que sintetiza los aspectos clave del diseño centrado en el usuario, las hipótesis de negocio y las características esenciales del producto. Este canvas sirve como una herramienta visual para alinear al equipo en torno a la propuesta de valor y los objetivos estratégicos de la startup.

<img src="assets/images/chapter-1/lean-ux-canvas/leax_ux_canvas.png" alt="Lean UX Canvas de Foodly" title="Lean UX Canvas de Foodly" style="width: 100%; height: auto; border-radius: 8px;" />
...
<img src="assets/images/chapter-5/landing_page.png" alt="landing deploy" style="width: 60%; height: auto; border-radius: 8px;" />
...
* **Repositorio del Informe (Foodly-report):**
<img src="assets/images/chapter-5/contributors_evidence_team.png" alt="team collaboration insights" style="width: 50%; height: auto; border-radius: 8px;" />

* **Repositorio de la Landing Page:**
<img src="assets/images/chapter-5/contributors_evidence_landing_page.png" alt="team collaboration insights landing page" style="width: 50%; height: auto; border-radius: 8px;" />
...
| **T2.2** | Implementación del **Community Service** para persistencia de reseñas y sistema de favoritos. | Backend | **EP04 / US08 / US12** | Vega Coronado, Fabricio Samir | 5 |
| **T2.3** | Desarrollo del **Business Service** para la gestión del perfil comercial, menús y contratos de los huariques independientes. | Backend | **EP03 / US05 / TS03** | Julca Minaya, Sergio Gino | 5 |
| **T2.4** | Construcción de las vistas del Frontend en Vue.js (Vista del Cliente). | Frontend | **US01 / US03** | Villanueva Andrade, Ysaac Ligorio| 5 |
| **T2.5** | Implementación de interfaces Frontend en Vue.js para la gestión del Perfil del Restaurante y el historial de contratos. | Frontend | **US05 / US07** | Cacho Seminario, Diego Alonso | 5 |
...
En esta sección se presentan las vistas de despliegue de **Foodly**, elaboradas con el objetivo de identificar en qué componentes tecnológicos se ubica cada parte del software y cómo estos se distribuyen físicamente entre el cliente, el servidor de aplicaciones y los servicios de nube contratados. Se elaboran dos niveles de abstracción complementarios: un **diagrama lógico**, que representa la separación de responsabilidades entre el Frontend y el Backend independientemente de su ubicación física; y un **diagrama físico**, que detalla la infraestructura real sobre la cual se ejecuta cada componente, incluyendo el enrutamiento a través de Internet, el API Gateway, los contenedores Docker por microservicio y los proveedores de nube utilizados para la persistencia de datos.

##### 5.4.1 Cloud Architecture Diagram

El siguiente diagrama lógico tiene como objetivo identificar dónde se encuentra alojada la funcionalidad del sistema, diferenciando claramente la capa de presentación (Frontend en Vue.js) de la capa de lógica de negocio (Backend en Java y Jakarta EE), y mostrando cómo ambas capas se comunican mediante el protocolo HTTP hacia la base de datos políglota del sistema.

![test1](assets/images/sprint4/diagramalogico.png)

Link del diagrama: https://miro.com/welcomeonboard/WW5kcjdmczhYOTd2YW5EN0NlTGNXbEdudjdnWklwM1IzdmdFKzY3RnhIYWxYUjJFaUNlMXRZajczVnJZcmprd3Y3SlE0MWR6UHdWN0RjbG5xR01reWZ6SVhjZ255RHJzTjZ5eEZRSXFkZjlsaklOVDVTWVZWeGkvY0drdVpSSDdnbHpza3F6REdEcmNpNEFOMmJXWXBBPT0hdjE=?share_link_id=101536304439

##### 5.4.2 Cloud Architecture Deployment (AWS, Microsoft Azure or Google Cloud)

A diferencia del diagrama lógico, esta vista física identifica el estilo de arquitectura empleado y las partes reales que la componen: la solicitud del usuario viaja desde la aplicación web en Vue.js a través de Internet hasta el API Gateway (Nginx), que enruta el tráfico hacia el servidor de aplicaciones WildFly. Dentro de este, cada microservicio se ejecuta en su propio contenedor Docker siguiendo el patrón *Database-per-Service*, y se comunica de forma asíncrona con el Message Broker (ActiveMQ) para las operaciones que no requieren respuesta inmediata. Finalmente, la persistencia se distribuye entre los servicios de base de datos relacional y no relacional alojados en Microsoft Azure, junto con la caché en memoria Redis desplegada en un contenedor propio.

![test1](assets/images/sprint4/diagramafisico.png)
